...
function displayPhotographerInfos(data) {
...
function displayPhotographerProfilePicture(data) {
    const { portrait } = data;

    const photographerProfilePicture = document.createElement("div");

    photographerProfilePicture.innerHTML = `
        <img class="profile_picture" src="../../assets/photographers/Photographers ID Photos/${portrait}" alt="">
    `;
...
function displayData(photographers) {
    ...
    const photographerInfosModel = displayPhotographerInfos(photographer);
    const photographerProfilePictureModel = displayPhotographerProfilePicture(photographer);
...
//     photographerHeader.prepend(photographerModel.getUserCardDOM(), contactButton);
